...
public class Item {
    ...
    public Int2FloatLinkedOpenHashMap getUserRated() {
        return userRated;
    }

    public double[] getUserRatedAsArray() {
     ...
     * @return
     */
    public double[] getLowLevelFeatureAsArray() {
     ...
     * @return the tags
     */
    public final ObjectSet<String> getTags() {
        return tags;
    }
     ...
     * @return the genres
     */
    public final FloatArrayList getGenres() {
        return genres;
    }
     ...
     */
    public final FloatArrayList getLowLevelFeature() {
        return lowLevelFeature;
    }

    /**
     * @param lowLevelFeature the lowLevelFeature to set
     */
    public final void setLowLevelFeature(
            FloatArrayList lowLevelFeature) {
        this.lowLevelFeature = new FloatArrayList(lowLevelFeature);
    }

    /**
     * @param userRated the userRated to set
     */
     ...
     * @return
     */
    public double[] getGenresAsArray() {
